...
class WxValidate {
  ...
  __initMethods() {
    ...
    that.methods = {
       ...
       */
      tel(value) {
        return that.optional(value) || /^(13[0-9]|14[5-9]|15[012356789]|166|17[0-8]|18[0-9]|19[8-9])[0-9]{8}$/.test(value)
      },
       ...
       */
      nonumber(value) {
        return that.optional(value) || /^[\u4e00-\u9fa5a-zA-Z]/.test(value)
      },
      /**
       * 验证URL格式
       */
      ...
      idcard(value) {
        ...
        // return that.optional(value) || /^[1-9]\d{7}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}$|^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}([0-9]|X)$/.test(value)
      },
      /**
       * 验证两个输入框的内容是否相同
       */
      equalTo(value, param) {
        return that.optional(value) || value === that.data[param] || value === param
      },
      /**
       * 验证是否包含某个值
       */
